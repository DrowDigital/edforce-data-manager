...
<div class="msd-container">
    ...
    <div class="msd-section">
        <div class="msd-tabs">
            <button class="msd-tab-button active" onclick="switchTab('add-data')">Add Training Calender</button>
            <button class="msd-tab-button" onclick="switchTab('show-data')">Show Training Calendar</button>
        </div>
