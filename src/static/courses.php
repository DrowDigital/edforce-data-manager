...
<div class="msd-container">
    ...
    <div class="msd-section">
        <div class="msd-tabs">
            <button class="msd-tab-button active" onclick="switchTab('add-data')">Add Course</button>
            <button class="msd-tab-button" onclick="switchTab('show-data')">Show Course</button>
        </div>
        ...
        <div id="add-data" class="msd-tab-content active">
            ...
            <form method="post" action="">
                <div class="msd-form-group">
                    <label for="data_subcategory">Select Course</label>
